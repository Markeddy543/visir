"""This code makes a flat file from images taken from VISIR,
 and saves it in the same directory. The file made here will 
be used in the VISIR_CALIBRATION.py file """
